...
Make sure you have Firebase configured with your project.
Update the firebaseConfig object in script.js with your Firebase project details.
Serve the project using a local server or host it on a web server.
...
Usage
Sign Up: Register with a valid email and password.
Log In: Use your credentials to log in. If your behavior triggers security measures, you'll need to pass a CAPTCHA or reset your password.
Idle Timer: Stay active on the page to avoid automatic logout due to inactivity.
Future Enhancements
